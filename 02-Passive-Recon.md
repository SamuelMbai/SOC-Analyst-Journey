...
In this room, I will be focusing on Passive Reconnaissance.

## Task 1: Introduction

I learnt three command-line tools:

- whois to query WHOIS servers
- nslookup to query DNS servers
- dig to query DNS servers\

There are two online services allow us to collect information about our target without directly connecting to it.
...
## Task 2: Active versus passive Recon
...
For more advanced DNS queries and additional functionality, you can use dig, the acronym for "Domain Information Groper," if you are curious. We can use:

```bash
dig DOMAIN_NAME
```

but to specify the record type, we would use:
